          ...
          <div className="max-w-2xl mx-auto px-2">
            <div className="relative">
              <input
                ...
                className="w-full px-4 sm:px-6 py-3 sm:py-4 rounded-lg sm:rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl text-white text-sm sm:text-base placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-orange-500/50"
              />
              <button className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-orange-500 hover:bg-orange-600 text-white p-2 sm:p-3 rounded-lg sm:rounded-xl transition-all shadow-lg shadow-orange-500/20">
                <FaSearch />
              </button>
            </div>
          </div>
            ...
            <div className="relative bg-white/5 border border-white/10 backdrop-blur-xl rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 p-4 sm:p-8">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-4 group-hover:text-orange-400 transition-colors">
                    {filteredPosts[0].title}
                  </h2>
                  <p className="text-gray-400 text-sm sm:text-base md:text-lg mb-6 line-clamp-3">
                    {filteredPosts[0].excerpt}
                  </p>
                  <div className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-4 text-xs sm:text-sm text-gray-500 mb-6">
                  ...
                  <button className="bg-orange-500 hover:bg-orange-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg sm:rounded-xl font-bold w-fit flex items-center gap-2 text-sm sm:text-base transition-all shadow-lg shadow-orange-500/20">
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3">
          {categories.map((category) => (
            <button
              ...
              className={`px-4 sm:px-6 py-2 sm:py-2.5 rounded-full font-bold text-sm sm:text-base transition-all ${
        ...
        {filteredPosts.length > 0 ? (
            ...
            {filteredPosts.map((post, index) =>
              ...
              searchQuery === "" ? null : (
                <div key={post.id} className="group relative">
                  <div className="absolute -inset-0.5 bg-linear-to-r from-orange-600 to-orange-400 rounded-2xl sm:rounded-3xl blur opacity-0 group-hover:opacity-20 transition duration-500"></div>
                  <div className="relative bg-white/5 border border-white/10 backdrop-blur-xl rounded-2xl sm:rounded-3xl overflow-hidden transition-all duration-300">
                    {/* Image */}
                    ...
                    {/* Content */}
                    <div className="p-6">
                      <h3 className="text-base sm:text-lg font-bold text-white mb-3 line-clamp-2 group-hover:text-orange-400 transition-colors cursor-pointer">
                        {post.title}
                      </h3>
                      ...
                      {/* Meta Info */}
                      <div className="flex flex-col sm:flex-row flex-wrap gap-2 text-xs text-gray-500 mb-4 pb-4 border-b border-white/10">
                        <span className="flex items-center gap-1">
                          <FaUser className="text-orange-400 text-sm" />{" "}
                          {post.author}
                        </span>
                        <span className="flex items-center gap-1">
                          <FaCalendar className="text-orange-400 text-sm" />{" "}
                          {post.date}
                        </span>
                      ...
                      {/* Read More Button */}
                      <button className="w-full bg-orange-500 hover:bg-orange-600 text-white py-2 sm:py-2.5 rounded-lg sm:rounded-xl font-bold text-sm sm:text-base transition-all flex items-center justify-center gap-2 shadow-lg shadow-orange-500/20">
          ...
          <div className="text-center py-12 sm:py-16">
            ...
            <button
              ...
              className="bg-orange-500 hover:bg-orange-600 text-white px-6 sm:px-8 py-2 sm:py-3 rounded-lg sm:rounded-xl font-bold text-sm sm:text-base transition-all shadow-lg shadow-orange-500/20"
            >
              Clear Filters
            </button>
          </div>
      ...
      <section className="relative py-12 sm:py-20 mt-8 sm:mt-12 z-10 overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 text-center relative overflow-hidden">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-white relative z-10">
              Subscribe to Our Newsletter
            </h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-400 mb-8 max-w-xl mx-auto relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto relative z-10 w-full">
              ...
              />
              <button className="bg-orange-500 hover:bg-orange-600 text-white px-6 sm:px-8 py-3 rounded-lg sm:rounded-xl font-bold text-sm sm:text-base transition-all shadow-lg shadow-orange-500/20 whitespace-nowrap shrink-0">
                Subscribe
              </button>
            </div>
          </div>
